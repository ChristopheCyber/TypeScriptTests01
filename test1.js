...
class HondaCar extends Car {
    constructor(name, engineCapacity, seatingCapacity) {
...
class Department2 {
    ...
    constructor(s1, employeePriv = s1) {
        this.s1 = s1;
